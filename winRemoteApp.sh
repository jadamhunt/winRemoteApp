...
echo -n '-drive file=/home/jhunt/ISOs/Tiny10.iso,index=0,media=cdrom,if=ide -drive file=/home/jhunt/win/virtiowin.iso,index=1,media=cdrom,if=ide' | lxc config set win10 raw.qemu

# modify apparmor settings for VM read/write permissions
lxc config set win10 raw.apparor "/home/** rwk,"
